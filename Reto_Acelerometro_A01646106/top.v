module top(
    ...
    // RAM de 40 bits
    wire [39:0] ram_data_in;
    wire [39:0] ram_data_out;
    ...
    wire [7:0] ram_garra = ram_data_out [7:0];
	 ...
	 assign ram_data_in = {mapped_out_x, mapped_out_y1, mapped_out_y2, mapped_out_z, (garra ? 8'd90: 8'd0)};
    ...
    always @(posedge clk_60hz) begin
        ...
        smooth_auto_garra <= smooth_auto_garra + 4;

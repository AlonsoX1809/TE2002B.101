module accel (
   ...
   output wire [15:0] raw_z,
	output wire [7:0] mapped_out_x,
	output wire [7:0] mapped_out_y1,
	output wire [7:0] mapped_out_y2,
	output wire [7:0] mapped_out_z
);
	...
	assign mapped_out_x  = mapped_x[7:0];
	assign mapped_out_y1 = mapped_y_1[7:0];
	assign mapped_out_y2 = mapped_y_2[7:0];
